const translations = {
  en: {
    title: "Oakbase — Managed AI Operations for Professional Services",
    description: "Oakbase designs, deploys and runs measurable business operations for law and wealth management firms.",
    strings: {
      ...
      "nav.trust": "Trust",
      "nav.cta": "Book a demo",
      "hero.eyebrow": "Managed AI operations for professional services",
      "hero.title": "Let experts focus on what matters",
      ...
      "manifesto.copy": "Your professionals keep the judgement. Oakbase runs the operation.",
      "workspace.preview.label": "Illustrative product data · not customer results",
      ...
      "method.copy": "We start with one high-value operation, establish its baseline, put it into production, then run and improve it with your team.",
      ...
      "method.five.copy": "Monitor performance, resolve exceptions, improve the live operation and expand into the next operations.",
      "trust.kicker": "Built for sensitive operations",
      "trust.title": "Trust is<br />non-negotiable.",
      "trust.copy": "Oakbase applies defined controls for sensitive operations: least-privilege access, human review, tenant isolation and auditable execution.",
      "trust.one.label": "Security",
      "trust.one.title": "Protected in transit and at rest.",
      "trust.one.copy": "Encryption, least-privilege access and auditable activity protect data across the operation.",
      "trust.one.proof.one": "TLS in transit + encryption at rest",
      "trust.one.proof.two": "Least-privilege access",
      "trust.one.proof.three": "Auditable activity",
      "trust.two.label": "Scalability",
      "trust.two.title": "Controlled as operations grow.",
      "trust.two.copy": "Tenant isolation, permissions and observable execution keep each operation governed as teams and volume grow.",
      "trust.two.proof.one": "Tenant isolation",
      "trust.two.proof.two": "Operation permissions",
      "trust.two.proof.three": "Observable execution",
      "trust.three.label": "Privacy",
      "trust.three.title": "Customer data stays controlled.",
      "trust.three.copy": "Customer Data is processed to perform requested features, not for model training. Content is handled transiently and operational records are minimised.",
      "trust.three.proof.one": "Transient content processing",
      "trust.three.proof.two": "No model training",
      "trust.three.proof.three": "Firm-controlled permissions",
      "demo.kicker": "Book a demo",
      "demo.title": "Which operation should your team stop running manually?",
      "demo.copy": "Tell us the minimum context. We’ll define the operation, its baseline and the measurable outcome.",
      ...
      "footer.copy": "© 2026 Oakbase. Managed AI operations for professional services firms."
    }
  },
  es: {
    title: "Oakbase — Operaciones de IA gestionadas para servicios profesionales",
    description: "Oakbase diseña, despliega y gestiona operaciones de negocio medibles para despachos de abogados y firmas de gestión patrimonial.",
    strings: {
      ...
      "hero.eyebrow": "Operaciones de IA gestionadas para servicios profesionales",
      "hero.title": "Que los expertos se centren en lo que importa",
      ...
      "manifesto.copy": "Tus profesionales mantienen el criterio. Oakbase gestiona la operación.",
      "workspace.preview.label": "Datos ilustrativos del producto · no son resultados de clientes",
      ...
      "method.copy": "Empezamos con una operación de alto valor, establecemos su punto de partida, la ponemos en producción y después la gestionamos y mejoramos junto a tu equipo.",
      ...
      "method.five.copy": "Monitorizamos el rendimiento, resolvemos excepciones, mejoramos la operación activa y ampliamos a nuevas operaciones.",
      "trust.kicker": "Diseñado para operaciones sensibles",
      "trust.title": "La confianza no es<br />negociable.",
      "trust.copy": "Oakbase aplica controles definidos para operaciones sensibles: acceso de mínimo privilegio, revisión humana, aislamiento entre clientes y ejecución auditable.",
      "trust.one.label": "Seguridad",
      "trust.one.title": "Protección en tránsito y en reposo.",
      "trust.one.copy": "El cifrado, el acceso de mínimo privilegio y la actividad auditable protegen los datos durante la operación.",
      "trust.one.proof.one": "TLS en tránsito + cifrado en reposo",
      "trust.one.proof.two": "Acceso de mínimo privilegio",
      "trust.one.proof.three": "Actividad auditable",
      "trust.two.label": "Escalabilidad",
      "trust.two.title": "Control a medida que crecen las operaciones.",
      "trust.two.copy": "El aislamiento entre clientes, los permisos y la ejecución observable mantienen cada operación gobernada a medida que crecen los equipos y el volumen.",
      "trust.two.proof.one": "Aislamiento entre clientes",
      "trust.two.proof.two": "Permisos por operación",
      "trust.two.proof.three": "Ejecución observable",
      "trust.three.label": "Privacidad",
      "trust.three.title": "Los datos del cliente permanecen controlados.",
      "trust.three.copy": "Los Datos del Cliente se procesan para ejecutar las funciones solicitadas, no para entrenar modelos. El contenido se trata de forma transitoria y los registros operativos se minimizan.",
      "trust.three.proof.one": "Tratamiento transitorio del contenido",
      "trust.three.proof.two": "Sin entrenamiento de modelos",
      "trust.three.proof.three": "Permisos controlados por la firma",
      "demo.kicker": "Reserva una demo",
      "demo.title": "¿Qué operación debería dejar de ejecutar manualmente tu equipo?",
      "demo.copy": "Cuéntanos el contexto mínimo. Definiremos la operación, su punto de partida y el resultado medible.",
      ...
      "footer.copy": "© 2026 Oakbase. Operaciones de IA gestionadas para firmas de servicios profesionales."
    }
  }
};
