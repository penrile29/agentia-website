const translations = {
  en: {
    ...
    strings: {
      ...
      "industries.kicker": "Deep industry expertise, already operational",
      "industries.title": "Industry blueprints",
      "industries.copy": "We have mapped the workflows, controls and edge cases that run law firms and wealth management firms—then engineered them into ready-to-deploy agents.",
  ...
  es: {
    ...
    strings: {
      ...
      "industries.kicker": "Conocimiento sectorial profundo, ya operativo",
      "industries.title": "Blueprints por industria",
      "industries.copy": "Hemos mapeado los workflows, controles y casos límite que mueven los despachos y las firmas de wealth management, y los hemos convertido en agentes listos para desplegar.",
