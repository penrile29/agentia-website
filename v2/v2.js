  ...
  const details = {
    ...
    governance: {
      ...
      body: `<p>Your firm’s knowledge becomes more useful when you can understand how it connects and control how it is used.</p>
        ...
        <p class="lean-dialog-note">See our <a href="/security/">security</a> and <a href="/privacy/">privacy</a> policies.</p>`
    },
    preview: {
      ...
      body: `<p>This page presents Oakbase’s positioning around lasting firm memory, prebuilt agents and Managed Operations, with visibility and access controls.</p>
        ...
        <p>The existing <a href="/privacy/">privacy</a> and <a href="/security/">security</a> pages are unchanged. Product and policy alignment remains part of preparation for a production release.</p>
